...
describe('errors', () => {
  test('all domain errors expose stable codes', () => {
    const errors: OrchestratorError[] = [
      ...
      new AuthorizationScopeDeniedError('jobs:write', 'ops'),
      ...
      new SessionTransportUnavailableError('session_01', 'reattach'),
      new SessionReattachFailedError('session_01'),
      new SessionInputRejectedError('session_01'),
